var actions = {
    setting: {
        url_restart: $('#config').data('restart'),
        url_restarttarget: $('#config').data('restarttarget'),
        url_shutdown: $('#config').data('shutdown'),
        url_supermodel: $('#config').data('supermodel'),
        url_usbstate: $('#config').data('usbstate'),
        url_check: $('#config').data('check'),
        runstate: false
    },
    // restart all service
    ...
    supermode: function(mode) {
        this.sendPost('supermode_success', this.setting.url_supermodel, {
            's': mode
        });
    },
    // set normal mode
    normalmode: function(mode) {
        this.sendPost('normalmode_success', this.setting.url_supermodel, {
            's': mode
        });
    },
    // check usb run state
